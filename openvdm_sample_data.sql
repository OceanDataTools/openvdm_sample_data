...
INSERT INTO `OVDM_CruiseDataTransfers` VALUES (1,'SSDW','Shoreside Data Warehouse',4,'/data/sample_data/ssdw',0,'','','','','','','','localhost','survey',1,NULL,2,1,1,0,128,0,0,'0','0'),(2,'Local_Copy','Cruise copy to local directory',1,'/data/sample_data/local_destination',0,'','','','','','','','','',0,'',2,1,0,0,0,0,0,'0','0'),(3,'Cruise_Auth_SMB','Cruise copy to authenticated SMB share',3,'/',0,'','','','//localhost/SampleAuthDestination','survey','sample_smb_passwd','WORKGROUP','','',0,'',2,1,0,0,0,0,0,'0','0'),(4,'Cruise_Anon_SMB','Cruise copy to anonymous SMB share',3,'/',0,'','','','//localhost/SampleAnonDestination','guest','','WORKGROUP','','',0,'',2,1,0,0,0,0,0,'0','0'),(5,'cruise_rsync','Cruise copy to rsync server',2,'/',0,'localhost/sample_dest','survey','b4dPassword!','','','','','','',0,'',2,1,0,0,0,0,0,'0','0'),(6,'cruise_ssh','Cruise copy to SSH server',4,'/data/sample_data/ssh_destination',0,'','','','','','','','localhost','survey',1,NULL,2,1,0,0,0,0,0,'0','0');
