...
INSERT INTO `OVDM_CollectionSystemTransfers` VALUES (1,'OpenRVDAS','OpenRVDAS (SSH Server)',0,'/vault/sample_data/ssh_source/OpenRVDAS','OpenRVDAS',0,0,0,1,1,0,4,0,'','','','','','','','127.0.0.1','survey',1,NULL,'*','','',2,1,0,0),
...
(4,'CTD','SBE 911+ CTD (Local Directory)',0,'/vault/sample_data/local_source/CTD','CTD ',0,0,0,1,1,0,1,0,'','','','','','','','','',0,'','*{cruiseID}_CTD[0-9][0-9][0-9]_*','','*decktest*',2,1,0,0),
(5,'Sealog','Sealog (Guest SMB Share)',0,'sealog','Sealog',0,0,0,1,1,0,3,0,'','','','//localhost/SampleAnonSource','guest','','WORKGROUP','','',0,'','*','','',2,1,0,0),
(6,'ROV_OpenRVDAS','OpenRVDAS collecting data for ROV',1,'/vault/sample_data/local_source/OpenRVDAS','OpenRVDAS',0,0,0,1,1,0,1,0,'','','','','','','','','',0,'','*','','',2,1,0,0);
...
INSERT INTO `OVDM_CruiseDataTransfers` VALUES (1,'SSDW','Shoreside Data Warehouse',1,1,0,4,'/vault/sample_data/ssdw',0,'','','','','','','','localhost','survey',1,NULL,2,1,1,0,128,0,0,'0','0'),
(2,'Local_Copy','Cruise copy to local directory',1,1,0,1,'/vault/sample_data/local_destination',0,'','','','','','','','','',0,'',2,1,0,0,0,0,0,'0','0'),
...
(6,'cruise_ssh','Cruise copy to SSH server',1,1,0,4,'/vault/sample_data/ssh_destination',0,'','','','','','','','localhost','survey',1,NULL,2,1,0,0,0,0,0,'0','0');
...
INSERT INTO `OVDM_ExtraDirectories` VALUES (1,'Transfer_Logs','Transfer Logs','OpenVDM/TransferLogs',1,1),
...
(4,'Tracklines','Cruise Tracklines','Products/Tracklines',1,0);
...
(5,'GGA_FILES','GGA Files',1,1,0,'*_GGA-*.txt',1,0),
(6,'MET','Met raw files',3,1,0,'*MET-*.txt,*TSG_Raw-*.txt',1,0);
